...
export const addVideo = (data, courseId) => (dispatch) => {
  ...
  request.post(`/videos/add/${courseId}`, data, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  })
...
export const getProduct = (page, limit, search, order) => (dispatch) => {
  dispatch({ type: PRODUCT_REQUEST });
  request.get(`/courses`, {
    params: { page, limit, q: search, sortBy: "price", sortOrder: order },
    headers: {
      Authorization: `Bearer ${token}`,
    },
  })
...
export const patchProduct = (id, data) => (dispatch) => {
  dispatch({ type: PRODUCT_REQUEST });
  request.patch(`/courses/update/${id}`, data, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  })
...
export const patchUser = (id, data) => (dispatch) => {
  dispatch({ type: PRODUCT_REQUEST });
  request.patch(`/users/update/${id}`, data, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  })
...
export const deleteProduct = (id) => (dispatch) => {
  dispatch({ type: PRODUCT_REQUEST });
  request.delete(`/courses/delete/${id}`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  })
