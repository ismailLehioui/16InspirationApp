      ...
      <div className="px-[24px]">
        <div>
          ...
          <div className="w-full justify-center items-center flex flex-col space-y-[8px]">
            <p className="text-[9px]">Starting at 150 DT per month</p>
        ...
        <div className="flex space-x-2 place-items-baseline">
          <p className="font-bold text-sm">{price} DT</p>
          <p className="line-through text-xs ">{((price*(+random+100))/100).toFixed()} DT</p>
